  ...
  <div className="flex items-center min-h-14 sm:min-h-16 md:min-h-20 lg:min-h-24 py-2 sm:py-3 bg-white dark:bg-gray-900 backdrop-blur-xl text-slate-800 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 shadow-sm gap-1 sm:gap-2 md:gap-4 px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="relative cart-dropdown">
              ...
              {cartDropdownOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-gray-900 rounded-lg shadow-lg z-50 border border-gray-200 dark:border-gray-700">
                  <div className="p-4">
                    <span className="text-lg font-bold">
                      {isMounted ? addToCartList?.length : 0} Items
                    </span>
                    <span className="block text-info mt-1">
                      Subtotal: ₹{isMounted ? subTotal.toLocaleString("en-IN") : "0"}
                    </span>
                    <div className="mt-3">
                      <Link href={"/cart"} className="block w-full text-center py-2 rounded bg-blue-600 text-white hover:bg-blue-700 transition">
                        View cart
                      </Link>
                    </div>
                  </div>
